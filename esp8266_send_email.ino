...
#define WIFI_SSID "D-Link DIR-612"
#define WIFI_PASSWORD "qwertyuiop12345"
...
#define AUTHOR_EMAIL "marifrahmans456@gmail.com"
...
void setup()
{
  ...
  */
  ...
  if (SD.begin(15))
  {
    ...
    if (SD.exists("/esp8266.png"))
      SD.remove("/esp8266.png");
    if (SD.exists("/bin1.dat"))
      SD.remove("/bin1.dat");

    Serial.println("Preparing SD file attachments...");

    const char *esp8266Img = "";

    File file = SD.open("/esp8266.png", FILE_WRITE);
    file.print(esp8266Img);
    file.close();
  ...
  */
  ...
  message.addRecipient("user1", "marifrahmans@gmail.com");

  /** Two alternative content versions are sending in this example e.g. plain text and html */
  message.html.content = "<span style=\"color:#ff0000;\">This message contains 2 inline images and 2 attachment files.</span><br/><br/><img src=\"gambaresp8266.png\"  width=\"100\" height=\"100\"> <img src=\"esp8266.png\" width=\"100\" height=\"100\">";
  ...
  */
  att.descr.filename = "esp8266.png";
  att.descr.mime = "image/png";
  att.file.path = "/esp8266.png";
  ...
  */
  ...
  /** The esp8266.png file is already base64 encoded file.
  ...
  */
  message.resetAttachItem(att); //Clear the attach item data to reuse
  att.descr.filename = "gambaresp8266.png";
  att.descr.mime = "image/png";
  att.file.path = "/gambaresp8266.png";
